...
export enum ValidatorID
{
    ...
    MISSING_ENV_CONFIG_MAP_KEY = 'MISSING_ENV_CONFIG_MAP_KEY',
    MISSING_VOLUME_MOUNT_SECRET = 'MISSING_VOLUME_MOUNT_SECRET',
    MISSING_ENV_SECRET = 'MISSING_ENV_SECRET',
    MISSING_ENV_SECRET_KEY = 'MISSING_ENV_SECRET_KEY',
    MISSING_SVC_ACCOUNT_SECRET = 'MISSING_SVC_ACCOUNT_SECRET',
    ...
    MISSING_INGRESS_SERVICE_PORT = 'MISSING_INGRESS_SERVICE_PORT',
    ...
    TRAEFIK_MISSING_MIDDLEWARE = 'TRAEFIK_MISSING_MIDDLEWARE',
    TRAEFIK_MISSING_SERVICE = 'TRAEFIK_MISSING_SERVICE',
    TRAEFIK_MISSING_TLS_OPTIONS = 'TRAEFIK_MISSING_TLS_OPTIONS',
    TRAEFIK_UNUSED_MIDDLEWARE = 'TRAEFIK_UNUSED_MIDDLEWARE',
    TRAEFIK_UNUSED_SERVICE = 'TRAEFIK_UNUSED_SERVICE',
    TRAEFIK_UNUSED_TLS_OPTIONS = 'TRAEFIK_UNUSED_TLS_OPTIONS',
}
