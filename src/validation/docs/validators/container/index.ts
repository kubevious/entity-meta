...
import { setupMISSING_ENV_CONFIG_MAP_KEY } from './MISSING_ENV_CONFIG_MAP_KEY'
import { setupMISSING_ENV_SECRET } from './MISSING_ENV_SECRET'
import { setupMISSING_ENV_SECRET_KEY } from './MISSING_ENV_SECRET_KEY'
...
export function setupContainerValidators(builder: ValidatorsDocsBuilder) {
  ...
  setupMISSING_ENV_CONFIG_MAP_KEY(builder);
  setupMISSING_ENV_SECRET(builder);
  setupMISSING_ENV_SECRET_KEY(builder);
